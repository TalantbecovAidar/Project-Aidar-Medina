    ...
    <Box> 
      ...
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" sx={{fontWeight:200, marginTop: "50px", marginLeft: "18px", fontSize: "18px"}}>
    ...
    <Card className="card" sx={{ maxWidth: 345, borderRadius: "20px", marginLeft: "50px", height:450 }}>
      <CardActionArea>
        ...
        <CardContent>
          ...
          <Typography variant="body2" color="text.secondary" sx={{fontWeight:200, marginTop: "30px", marginLeft: "18px", fontSize: "18px"}}>
